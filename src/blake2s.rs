...
mod tests {
    ...
    fn test_empty_input() {
        ...
        let expected = hex::decode("69217a3079908094e11121d042354a7c1f55b6482ca1a51e1b250dfd1ed0eef9").unwrap();
    ...
    fn test_abc() {
        ...
        let expected = hex::decode("508c5e8c327c14e2e1a72ba34eeb452f37458b209ed63a294d999b4c86675982").unwrap();
        assert_eq!(result, expected.as_slice());
    }
    ...
    fn test_genesis() {
        ...
        let reference = Blake2s256::digest(input);
        let ours = blake2s(input);
        let expected = hex::decode("00000000522473196b73bc619a8b18472c4cb4c6caf785a13fa32aaae7222ff6").unwrap();
        assert_eq!(ours, reference.as_slice());
